    ...
    <section ref={sectionRef} id="events" className="min-h-screen flex flex-col justify-center relative py-20 px-3 sm:px-4 md:px-4 bg-ivory overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-primary mb-4 text-glow">{config.eventsTitle}</h2>
              ...
              >
                ...
                <div className="p-6 md:p-8 flex flex-col gap-4 flex-grow justify-center">
                  <div className="flex items-center gap-4 text-gray-700">
                    <span className="text-primary"><FaCalendarAlt size={20} /></span>
                    <span className="text-lg">{event.date}</span>
                  </div>
                  
                  <div className="flex items-center gap-4 text-gray-700">
                    <span className="text-primary"><FaClock size={20} /></span>
                    <span className="text-lg">{event.time}</span>
                  </div>
                  
                  <div className="flex items-start gap-4 text-gray-700">
                    <span className="text-primary mt-1"><FaMapMarkerAlt size={20} /></span>
                    <div>
